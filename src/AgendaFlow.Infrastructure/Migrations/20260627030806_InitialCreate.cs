        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_availability_exceptions_professionals_ProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_availability_rules_professionals_ProfessionalId",
                        column: x => x.ProfessionalId,
                        principalTable: "professionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockedStartAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    BlockedEndAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_booking_confirmations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_booking_confirmations_appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_appointment_status_history_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_appointments_TenantId_ProfessionalId_Status",
                table: "appointments",
                columns: new[] { "TenantId", "ProfessionalId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_appointments_TenantId_StartAtUtc",
                table: "appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_availability_exceptions_ProfessionalId",
                table: "availability_exceptions",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_availability_exceptions_TenantId_ProfessionalId_Date",
                table: "availability_exceptions",
                columns: new[] { "TenantId", "ProfessionalId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_availability_rules_ProfessionalId",
                table: "availability_rules",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_availability_rules_TenantId_ProfessionalId",
                table: "availability_rules",
                columns: new[] { "TenantId", "ProfessionalId" });

            migrationBuilder.CreateIndex(
                name: "IX_booking_confirmations_AppointmentId",
                table: "booking_confirmations",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_booking_confirmations_TokenHash",
                table: "booking_confirmations",
                column: "TokenHash",
                unique: true);
